...
import type {
  ...
  DashboardGerenteListarAlertasEstoqueBaixoOutputItem,
...
export class DashboardGerenteDashboardGerenteBase extends CollabLitElement {
  ...
  @property()
  totalRevenue: DashboardGerenteConsultarDashboardGerenteOutput['totalRevenue'] | undefined = undefined;

  @property()
  orderCount: DashboardGerenteConsultarDashboardGerenteOutput['orderCount'] | undefined = undefined;

  @property()
  averageTicket: DashboardGerenteConsultarDashboardGerenteOutput['averageTicket'] | undefined = undefined;

  @property()
  itemsSold: DashboardGerenteConsultarDashboardGerenteOutput['itemsSold'] | undefined = undefined;

  @property()
  serieVendasPorTurno: DashboardGerenteConsultarDashboardGerenteOutput['serieVendasPorTurno'] | undefined = undefined;

  @property()
  rankingItensMaisVendidos: DashboardGerenteConsultarDashboardGerenteOutput['rankingItensMaisVendidos'] | undefined = undefined;
  ...
  async loadListarAlertasEstoqueBaixo(
    ...
    if ((window as any).mls) {
      ...
      ] as DashboardGerenteListarAlertasEstoqueBaixoOutputItem[];
      setState('ui.dashboardGerente.alertasEstoqueBaixo', this.alertasEstoqueBaixo);
      this.status = this.msg.loaded;
      return;
    }
    const response = await execBff<DashboardGerenteListarAlertasEstoqueBaixoOutputItem[]>(
