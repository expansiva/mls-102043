...
const message_pt = {
  ...
  criarPedidoLoading: 'Enviando pedido',
...
const message_en = {
  ...
  criarPedidoLoading: 'Sending order',
  couldNotCriarPedido: 'Could not create order',
  navigateToPainelCozinha: 'Order sent to kitchen',
};
...
export class PosRapidoBase extends CollabLitElement {
  private readonly _stateKeys = ['ui.posRapido.pedidos', 'ui.posRapido.criarPedido'] as const;

  @property() pedidos: PosRapidoListarPedidosOutput[] = [];

  @property() orderItems: PosRapidoCriarPedidoInput['orderItems'] = '';

  @property() observacao: PosRapidoCriarPedidoInput['observacao'] | undefined = undefined;
  ...
  handleIcaStateChange(key: string, value: any): void {
    switch (key) {
      ...
      case 'ui.posRapido.criarPedido':
        this.criarPedidoState = value ?? 'idle';
        break;
      default:
        break;
    }
      ...
      this.pedidos = [
        {
          ...
          updatedAt: '2026-06-19T09:16:00Z',
        },
        {
          orderId: 'id-002',
          status: 'em_preparo',
        ...
        },
        {
          ...
          updatedAt: '2026-06-19T09:40:00Z',
        },
      ] as PosRapidoListarPedidosOutput[];
      setState('ui.posRapido.pedidos', this.pedidos);
      this.status = this.msg.loaded;
      return;
    }
    const response = await execBff<PosRapidoListarPedidosOutput[]>(
